...
async function controlItemsHandler(event) {
    ...
    if (action) {
        ...
        if (action == 'show') {
            ...
            nameOption1.innerHTML = 'Легкие закуски и горячие напитки';
            nameOption2.innerHTML = 'трансфер после экскурсии';
            descOption1.innerHTML = 'Стоимость увеличивется на';
            descOption2.innerHTML = 'трансфер до ближайших станций метро после \
            экскурсии увеличивает стоимость на (в выходные дни/в будние) ';
            discountOption1.value = '+1000 р';
            discountOption2.value = '25%/30%';
        ...
        if (action == 'edit') {
            ...
            nameOption1.innerHTML = 'Легкие напитки и горячие закуски';
            nameOption2.innerHTML = 'трансфер после экскурсии';
            descOption1.innerHTML = 'Стоимость увеличивается на';
            descOption2.innerHTML = 'трансфер до ближайших станций метро после \
            экскурсии увеличивает стоимость на (в выходные дни/в будние) ';
            discountOption1.value = '+1000';
            discountOption2.value = '25%/30%';
...
async function buttonChooseGuideHandler(event) {
    ...
    excursionDate.value = getCurrentDate();
    option1Name.innerHTML = 'Легкие напитки и горячие закуски';
    option1Desc.innerHTML = 'Стоимость увеличивается на';
